...
Alle index, css og js filer er blevet optimeret i forskellig grad

GENERELT:

- korrekt navngivning af filer, img'er og audio
- korrekt mappestruktur - alle css sammen, js, img, audio og index filer i hovedmappen

HTML:

- semantiske tags og classes
- alle png filer er konverteret til svg
